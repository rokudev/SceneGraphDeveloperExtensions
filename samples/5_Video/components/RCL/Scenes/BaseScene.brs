...
sub Init()
    ...
    ' This is to avoid screen blinking
...
sub Show(args as Object)
    ? "please implement sub show(args) in your code in order to show any screen"
end sub
...
function onKeyEvent(key as String, press as Boolean)
    ' if back button is passed here screen stack is done with screens operaion
    ' user can override onKeyEvent to prevent closing channel and show exit dialog for example
