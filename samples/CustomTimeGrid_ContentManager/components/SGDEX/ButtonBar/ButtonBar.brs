...
sub SetButtonBarContent(content as Object)
    ...
    if newContent <> invalid
        ...
        if m.top.alignment = "top"
            ...
            m.buttonsRowList.numRows = buttonsCount
...
function AdjustButtonBarContent(content as Object)
    ...
    if m.top.alignment = "top"
        ...
        newContent.AppendChild(contentCopy)
    else if m.top.alignment = "left"
...
sub AlignButtonBar()
    ...
    if m.top.alignment = "top"
        ...
        m.autoHideArrow.uri = "pkg:/components/SGDEX/Images/ButtonBar/ic_arrow_right.png"
        m.autoHideArrow.height=25
        height = ((m.backgroundRectangle.height/2) - m.defaultOverhangHeight)
        m.autoHideHint.translation = [buttonBarX-m.autoHideArrow.width, height]
