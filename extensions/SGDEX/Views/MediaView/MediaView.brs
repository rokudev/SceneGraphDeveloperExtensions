...
' README:
' MediaView is a SGDEX component to play video or audio content
' In channel developer create MediaView,
' set content - content can be a single ContentNode or a playlist with multiple children
' to configure starting item, there is jumpToItem field see OnJumpToItem field
' and to configure to play - set control to "play"
' MediaView also supports preloading
